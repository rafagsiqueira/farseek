...
import "github.com/rafagsiqueira/farseek/internal/tfdiags"
...
func (c *deprecatedOutputDiagnosticExtra) WrapDiagnosticExtra(inner interface{}) {
	if c.wrapped != nil {
		...
		panic("Attempted to wrap a diagnostic extra into a deprecatedOutputDiagnosticExtra that is already wrapping a different extra. This is a bug in Farseek, please report it.")
	}
	c.wrapped = inner
}
