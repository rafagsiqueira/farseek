...
type DesiredResourceInstance struct {
	...
	// that we can eventually do https://github.com/rafagsiqueira/farseek/issues/2523 .
	...
	//
	// FIXME: Probably also need an "unknown" representation for this, so
	// that we can eventually do https://github.com/rafagsiqueira/farseek/issues/2522 .
