...
func (c *PlanCommand) Help() string {
	helpText := `
Usage: farseek [global options] plan [options]

  Generates a speculative execution plan, showing what actions Farseek would
...
Plan Customization Options:
  ...
  The following options customize how Farseek will produce its plan. You can
  also use these options when you run "farseek apply" without passing it a saved
  ...
  -destroy                Select the "destroy" planning mode, which creates a
                          ...
                          Farseek configuration instead of the usual behavior.

  -refresh-only           Select the "refresh only" planning mode, which checks
                          whether remote objects still match the outcome of the
                          most recent Farseek apply but does not propose any
                          actions to undo any changes made outside of Farseek.
  ...
  -replace=resource       Force replacement of a particular resource instance
                          ...
                          instance, Farseek will plan to replace it instead.
...
Other Options:
  ...
  -consolidate-warnings=false  If Farseek produces any warnings, do not
                               attempt to consolidate similar messages. All
                               locations for all warnings will be listed.

  -consolidate-errors          If Farseek produces any errors, attempt to
  ...
  -generate-config-out=path    (Experimental) If import blocks are present in
                               configuration, instructs Farseek to generate
                               ...
                               Farseek may still attempt to write
  ...
  -deprecation=module:m        Specify what type of warnings are shown.
                               ...
                               Default: all. When "all" is selected, Farseek
