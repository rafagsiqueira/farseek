...
func TestMetaBackend_configuredUnchangedWithStaticEvalVars(t *testing.T) {
	...
	// https://github.com/rafagsiqueira/farseek/issues/2024
	//
	...
	//    https://github.com/rafagsiqueira/farseek/issues/2118
	t.Cleanup(
			...
			ConfigOverride: hcltest.MockBody(&hcl.BodyContent{
				Attributes: hcl.Attributes{
					"workspace_dir": {
						...
						// argument value stored in the .terraform/farseek.tfstate file in the
	...
	if diags.HasErrors() {
		// The original problem reported in https://github.com/rafagsiqueira/farseek/issues/2024
