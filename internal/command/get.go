...
func (c *GetCommand) Help() string {
	helpText := `
Usage: farseek [global options] get [options]
  ...
  the "farseek init" command, so you should rarely need to run this
  command separately.
...
func (c *GetCommand) Synopsis() string {
	return "Install or upgrade remote Farseek modules"
}
