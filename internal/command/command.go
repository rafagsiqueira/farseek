...
// user-added plugin binaries. Farseek only reads from this path if it
// exists, it is never created by farseek.
const DefaultPluginVendorDir = "farseek.d/plugins/" + pluginMachineName

// DefaultStateFilename is the default filename used for the state file.
const DefaultStateFilename = "farseek.tfstate"
...
The "backend" in Farseek defines how Farseek operates. The default
