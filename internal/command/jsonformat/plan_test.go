...
import (
	...
	"github.com/rafagsiqueira/farseek/internal/command/jsonformat/differ"
	"github.com/rafagsiqueira/farseek/internal/command/jsonformat/structured"
	"github.com/rafagsiqueira/farseek/internal/command/jsonformat/structured/attribute_path"
  ...
  - resource "test_instance" "example" {
      - id = "i-02ae66f368e8518a9" -> null
		...
		"forget": {
			...
			RequiredReplace: cty.NewPathSet(),
			ExpectedOutput: `  # test_instance.example will be removed from the Farseek state but will not be destroyed
  . resource "test_instance" "example" {
    id = "i-02ae66f368e8518a9"
		...
		"forget a deposed object": {
			...
			RequiredReplace: cty.NewPathSet(),
			ExpectedOutput: `  # test_instance.example (deposed object byebye) will be removed from the Farseek state but will not be destroyed
  # (left over from a partially-failed replacement of this instance)
  . resource "test_instance" "example" {
    id = "i-02ae66f368e8518a9"
}`,
...
+/- resource "test_instance" "example" {}`,
  ...
  . resource "test_instance" "example" {}`,
		...
		"forget because no resource configuration": {
			...
			Schema:          emptySchema,
			RequiredReplace: cty.NewPathSet(),
			ExpectedOutput: `  # module.foo.test_instance.example will be removed from the Farseek state but will not be destroyed
  . resource "test_instance" "example" {}`,
		},
		"forget because no module": {
			...
			Schema:          emptySchema,
			RequiredReplace: cty.NewPathSet(),
			ExpectedOutput: `  # module.foo[1].test_instance.example will be removed from the Farseek state but will not be destroyed
  . resource "test_instance" "example" {}`,
		},
	}
