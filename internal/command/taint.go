...
func (c *TaintCommand) Help() string {
	helpText := `
Usage: farseek [global options] taint [options] <address>
  ...
  address will reach Farseek correctly, without any special
  interpretation.
