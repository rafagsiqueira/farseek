...
import (
	...
	tfplugin5 "github.com/rafagsiqueira/farseek/internal/plugin"
	tfplugin "github.com/rafagsiqueira/farseek/internal/plugin6"
	simple5 "github.com/rafagsiqueira/farseek/internal/provider-simple"
	simple "github.com/rafagsiqueira/farseek/internal/provider-simple-v6"
	proto5 "github.com/rafagsiqueira/farseek/internal/tfplugin5"
...
func TestUnmanagedSeparatePlan(t *testing.T) {
	...
	if tf.FileExists(filepath.Join(".farseek", "plugins", "registry.opentofu.org", "hashicorp", "test")) {
