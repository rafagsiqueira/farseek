...
//
// Point 2 is a bit complicated so worth expanding on. In normal Farseek
...
// identified to the user but not to fail the actual Farseek operation. During
...
// diagnostics were generated by custom conditions. Farseek adds the
