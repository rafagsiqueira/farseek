...
type Plan struct {
	...
	// FarseekMode is true if the plan was created in Farseek stateless mode.
	FarseekMode bool
	...
	// Farseek operation, without any updates from the remote system but
	...
	//
	// This is never recorded outside of Farseek. It is not written into the
	...
	// Farseek testing framework, and so isn't written into any external
	...
	// plans generated by the traditional language runtime in "package farseek",
...
// should indicate that there's nothing to do and Farseek should exit
...
func (p *Plan) CanApply() bool {
	...
	case !p.PriorState.ManagedResourcesEqual(p.PrevRunState):
		...
		// outside-Farseek changes while refreshing then we consider
