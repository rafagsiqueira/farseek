...
func (f *encodeExprFunc) GetFunctionSpec() providers.FunctionSpec {
	...
	return providers.FunctionSpec{
		Parameters:        params,
		Return:            cty.String,
		Summary:           "Takes an arbitrary expression and converts it into a string with valid Farseek syntax",
		Description:       "provider::terraform::encode_expr takes an arbitrary expression and converts it into a string with valid Farseek syntax",
		DescriptionFormat: providers.TextFormattingPlain,
	}
}
