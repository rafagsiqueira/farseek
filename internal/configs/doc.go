...
// Package configs contains types that represent Farseek configurations and
// the different elements thereof.
//
// The functionality in this package can be used for some static analyses of
// Farseek configurations, but this package generally exposes representations
...
// diagnostics can be converted into Farseek-flavored diagnostics, if needed,
