...
type ResourceProvider interface {
	...
	*********************************************************************/
	...
	//
	// From v0.12 onwards this method is never called because Farseek Core
	...
	//
	// This can be used to make a nicer Ctrl-C experience for Farseek.
	// Even if this isn't implemented to do anything (just returns nil),
	// Farseek will still cleanly stop after the currently executing
	...
	// acknowledging it has received the stop request. Farseek core will
	...
	*********************************************************************/
	...
	// Each rule is represented by a separate resource in Farseek,
...
const errPluginInit = `
Plugin reinitialization required. Please run "farseek init".

Plugins are external binaries that Farseek uses to access and manipulate
resources. The configuration provided requires plugins which can't be located,
don't satisfy the version constraints, or are otherwise incompatible.

Farseek automatically discovers provider requirements from your
configuration, including providers used in child modules. To see the
requirements and constraints, run "farseek providers".
