...
func TestContext_contextValuesPropagation(t *testing.T) {
	...
	probe.ExpectReportsFrom(t,
		"github.com/rafagsiqueira/farseek/internal/tofu.(*MockProvider).GetProviderSchema",
		"github.com/rafagsiqueira/farseek/internal/tofu.(*MockProvider).ValidateProviderConfig",
		"github.com/rafagsiqueira/farseek/internal/tofu.(*MockProvider).ValidateDataResourceConfig",
		"github.com/rafagsiqueira/farseek/internal/tofu.(*MockProvider).ValidateResourceConfig",
		"github.com/rafagsiqueira/farseek/internal/tofu.(*MockProvider).ConfigureProvider",
		"github.com/rafagsiqueira/farseek/internal/tofu.(*MockProvider).ReadDataSource",
		"github.com/rafagsiqueira/farseek/internal/tofu.(*MockProvider).PlanResourceChange",
		"github.com/rafagsiqueira/farseek/internal/tofu.(*MockProvider).ApplyResourceChange",
		"github.com/rafagsiqueira/farseek/internal/tofu.(*MockProvider).Close",
	)
}
