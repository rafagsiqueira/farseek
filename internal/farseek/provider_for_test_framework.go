...
// and overrides for that one specific resource instance, any other usage is a bug in Farseek and should
// be corrected.
...
// irrelevant in the scope of mocking / overriding. When running `farseek test` configuration
