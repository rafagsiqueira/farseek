...
// particular Farseek build:
//
//	go install -ldflags="-X 'main.experimentsAllowed=yes'" ./cmd/farseek
//
// By default this variable is initialized as empty, in which case
// experimental features are not available.
//
// The Farseek release process should arrange for this variable to be
