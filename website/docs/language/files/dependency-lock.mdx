...
description: >-
  OpenTofu uses the dependency lock file .farseek.lock.hcl to track and select
...
The lock file is always named `.farseek.lock.hcl`, and this name is intended
...
```diff
--- .farseek.lock.hcl	2020-10-07 16:12:07.539570634 -0700
+++ .farseek.lock.hcl	2020-10-07 16:12:15.267487237 -0700
@@ -6,6 +6,26 @@
   ]
 }
...
```diff
--- .farseek.lock.hcl	2020-10-07 16:44:25.819579509 -0700
+++ .farseek.lock.hcl	2020-10-07 16:43:42.785665945 -0700
@@ -7,22 +7,22 @@
 }
...
```diff
--- .farseek.lock.hcl	2020-10-07 17:24:23.397892140 -0700
+++ .farseek.lock.hcl	2020-10-07 17:24:57.423130253 -0700
@@ -10,6 +10,7 @@
   version     = "2.1.0"
   constraints = "~> 2.1.0"
   hashes = [
