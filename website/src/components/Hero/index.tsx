      ...
      <div className="container mx-auto px-4 md:px-8 py-16 min-h-[calc(100vh-8rem)] flex flex-col lg:flex-row items-center justify-center">
        <div className="lg:w-1/2 lg:pr-16">
          ...
          <div className="text-left">
            <Headline>Infrastructure without the Statefile</Headline>
             <p className="my-8 text-xl text-gray-600 dark:text-gray-400">
              Farseek is the stateless evolution of Infrastructure as Code. Stop managing state files. <br />
              <strong>Start managing infrastructure.</strong>
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-start">
              ...
              <Button
                variant="secondary"
                href="https://github.com/rafagsiqueira/farseek"
                className="w-full sm:w-auto"
              >
                View on GitHub
              </Button>
